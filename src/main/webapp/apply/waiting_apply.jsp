            ...
            <div class="table-div">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>四号楼委员会</th>
                        <th>报废（报损）</th>
                        <td align="center"><a class="btn btn-info" href="../apply.jsp" onclick="ahead()" target="_self">修改</a></td>
                        <td align="center"><a class="btn btn-info " href="../apply.jsp" onclick="ahead()" target="_self">取消申请</a></td>
